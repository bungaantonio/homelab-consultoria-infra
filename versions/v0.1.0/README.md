# HISTÓRICO - IMPLEMENTAÇÃO ENCERRADA (v0.1.0)

> [!WARNING]
> **ESTADO DO AMBIENTE: DESATIVADO / REMOVIDO**
>
> Esta documentação descreve uma implementação anterior de infraestrutura (versão **v0.1.0**), que foi **totalmente desativada e removida**.
> Os ficheiros e procedimentos contidos nesta pasta são mantidos apenas para:
> - Registo do conhecimento adquirido;
> - Histórico de decisões de design técnico;
> - Validação de conceitos e tecnologias.
>
> Para aceder ao desenho e especificações da arquitetura corporativa ativa atual, consulte o diretório raiz (**v0.2.0**).

***

# Infraestrutura Corporativa: HomeLab Consultoria & Contabilidade (v0.1.0)
